              ...
              <Grid container spacing={4}>
                ...
                <Grid item xs={12} md={6}>
                  <Box sx={{ p: 3, backgroundColor: 'grey.50', borderRadius: '16px', height: '100%' }}>
                    ...
                    <Chip
                      label={`₹${appointment.doctor.consultationFee}`}
                      sx={{
        ...
        <Fade in={true} timeout={1800}>
          ...
          >
            ...
            <Typography variant="body1">
              ...
              • Bring any relevant medical records, test results, or previous prescriptions<br/>
              • If you need to reschedule or cancel, please contact us at least 24 hours in advance<br/>
              • For emergencies, please call our emergency hotline immediately
            </Typography>
          </Alert>
        </Fade>
